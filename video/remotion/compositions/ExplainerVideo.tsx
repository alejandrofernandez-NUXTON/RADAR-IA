...
export function ExplainerVideo({ script, timeline, generatedDate }: VideoRenderProps) {
  ...
  return (
    <AbsoluteFill style={{ fontFamily: videoFonts.sans, backgroundColor: videoTheme.background, overflow: "hidden" }}>
      ...
      <div style={canvasStyle}><Captions text={caption?.text} /></div>
    </AbsoluteFill>
  );
}
